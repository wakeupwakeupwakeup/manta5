    ...
    return (
        <Layout>
            <>
                        ...
                        <Slide triggerOnce={true}>
                            <div className={"text-center mb-12"}>
                                <p>
                                    ...
                                    exclusive training sessions and test-drive the revolutionary Manta5 hydrofoil e-bikes.
                ...
                <section className={"bg-testDriveSection bg-cover text-white py-8"}>
                        ...
                        <div className={"grid grid-cols-1 lg:grid-cols-3 gap-14"}>
                            <div className={"flex flex-col items-center gap-3 grow"}>
                                <div className={"flex gap-2"}>
                                    <div>
                                        <img className={"w-[14px]"} src={"/patterns/sm_pattern.svg"}
                                             alt={"background"}/>
                                    </div>
                                    <h3 className={"text-white w-fit whitespace-nowrap"}>
                                        Expert Guidance
                                    </h3>
                                </div>
                                <p>
